...
(() => {
  ...
  const modules = {
    ...
    flashcards:{
      ...
      html:`
        <div class="flash-toolbar interactive-only"><div class="tag-row" id="flash-filters"></div><div class="flash-counter" id="flash-counter"></div></div>
        <section class="flash-grid interactive-only" id="flash-grid"></section>
    ...
    sources:{
      ...
      html:`
        <section class="section-block">
          ...
          <div class="source-item speech-unit"><h3>Uploaded Systemic Hypertension chapter</h3><p>Structured review covering diagnosis, secondary causes, organ damage, treatment, resistant hypertension, hypertensive emergency, kidney disease, cardiorenal syndromes, corrections, and rapid revision.</p><p style="margin-top:8px"><a href="assets/systemic-hypertension-source.pdf" target="_blank" rel="noopener">Open the included source PDF</a></p></div>
        </section>
        <section class="section-block">
